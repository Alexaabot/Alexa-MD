...
if wget -q https://github.com/Emergit2006/CharlieVentas/raw/master/musicSH/"$random_mp3"; then
...
echo -e "\033[01;33mpkg install git -y\npkg install nodejs -y\npkg install ffmpeg -y\npkg install imagemagick -y\npkg install yarn\ngit clone https://github.com/Emergit2006/CharlieVentas\ncd CharlieVentas\nnpm install\nyarn install\nnpm start\033[0m"
exit 1
else
...
echo -e "\033[1;35m"
git clone https://github.com/Emergit2006/CharlieVentas.git
